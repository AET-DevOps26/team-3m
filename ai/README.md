...
Ingest is bounded by two retention mechanisms so append-only RSS ingest can't exhaust the
shared database and take recommendation persistence down with it:
