...
const { I18nProvider, useI18n } = i18nBuilder
    ...
    .withCustomTranslations({
        en: {
            welcomeMessage:
                "Welcome to Kontor - Your gateway to seamless planning and organization.",
        ...
        ar: {
            welcomeMessage: "مرحبًا بك في Kontor - بوابتك إلى التخطيط والتنظيم السلس.",
        ...
        ca: {
            welcomeMessage:
                "Benvingut a Kontor: la vostra porta d'accés a una planificació i organització perfecta.",
        ...
        cs: {
            welcomeMessage:
                "Vítejte v Kontor – vaší bráně k bezproblémovému plánování a organizaci.",
        ...
        da: {
            welcomeMessage:
                "Velkommen til Kontor - din gateway til problemfri planlægning og organisering.",
        ...
        de: {
            welcomeMessage:
                "Willkommen bei Kontor – Ihr Zugang zu nahtloser Planung und Organisation.",
        ...
        el: {
            welcomeMessage:
                "Καλώς ήρθατε στην Kontor - Η πύλη σας για απρόσκοπτο σχεδιασμό και οργάνωση.",
        ...
        es: {
            welcomeMessage:
                "Bienvenido a Kontor: su puerta de entrada a una planificación y organización perfectas.",
        ...
        fa: {
            welcomeMessage:
                "به Kontor خوش آمدید - دروازه شما برای برنامه‌ریزی و سازماندهی بدون نقص.",
            ...
            welcomeMessage:
                "Tervetuloa Kontor:iin – porttisi saumattomaan suunnitteluun ja organisointiin.",
        ...
        fr: {
            welcomeMessage:
                "Bienvenue sur Kontor - Votre passerelle vers une planification et une organisation sans faille.",
        ...
        hu: {
            welcomeMessage:
                "Üdvözöljük az Kontor-nél – Az Ön kapuja a zökkenőmentes tervezéshez és szervezéshez.",
        ...
        it: {
            welcomeMessage:
                "Benvenuti in Kontor - Il vostro portale per una pianificazione e un'organizzazione senza interruzioni.",
        ...
        ja: {
            welcomeMessage:
                "Kontor へようこそ - シームレスな計画と組織化へのゲートウェイ。",
        ...
        ka: {
            welcomeMessage:
                "მოგესალმებით Kontor-ში - თქვენი კარიბჭე უწყვეტი დაგეგმვისა და ორგანიზებისთვის.",
        ...
        lt: {
            welcomeMessage:
                "Sveiki atvykę į „Kontor“ – jūsų vartai į sklandų planavimą ir organizavimą.",
        ...
        lv: {
            welcomeMessage:
                "Laipni lūdzam Kontor — jūsu vārti uz nevainojamu plānošanu un organizēšanu.",
        ...
        nl: {
            welcomeMessage:
                "Welkom bij Kontor - Uw toegangspoort tot naadloze planning en organisatie.",
        ...
        no: {
            welcomeMessage:
                "Velkommen til Kontor - din inngangsport til sømløs planlegging og organisering.",
        ...
        pl: {
            welcomeMessage:
                "Witamy w Kontor — Twojej bramie do bezproblemowego planowania i organizacji.",
        ...
        pt: {
            welcomeMessage:
                "Bem-vindo à Kontor - Sua porta de entrada para planejamento e organização integrados.",
        ...
        "pt-BR": {
            welcomeMessage:
                "Bem-vindo à Kontor - Seu portal para planejamento e organização contínuos.",
        ...
        ru: {
            welcomeMessage:
                "Добро пожаловать в Kontor — ваш путь к эффективному планированию и организации.",
        ...
        sk: {
            welcomeMessage:
                "Vitajte v Kontor – vašej bráne k bezproblémovému plánovaniu a organizácii.",
        ...
        sv: {
            welcomeMessage:
                "Välkommen till Kontor - din inkörsport till sömlös planering och organisering.",
        ...
        th: {
            welcomeMessage:
                "ยินดีต้อนรับสู่ Kontor - ประตูสู่การวางแผนและจัดระเบียบที่ราบรื่น",
        ...
        tr: {
            welcomeMessage:
                "Kontor'e hoş geldiniz - Kusursuz planlama ve organizasyona giden kapınız.",
        ...
        uk: {
            welcomeMessage:
                "Ласкаво просимо до Kontor — вашого шлюзу до безперебійного планування та організації.",
        ...
        "zh-CN": {
            welcomeMessage: "欢迎来到 Kontor - 开启无缝规划与组织的门户。",
        ...
        "zh-TW": {
            welcomeMessage: "歡迎來到 Kontor - 開啟無縫規劃與組織的門戶。",
