...
and the AI service's with `pgvector`), a RabbitMQ broker (subchart), and an
optional Keycloak. The chart README documents environment overlays (`values-prod.yaml`,
