...
/**
 * App-wide header rendered above all protected routes. Shows the Kontor logo
 * linking home and the authenticated user's name as a dropdown trigger with
 * risk tolerance preferences and a logout action.
 */
