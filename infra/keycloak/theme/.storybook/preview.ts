...
const preview: Preview = {
    parameters: {
        // Keycloak pages own their full-height layout (min-h-svh). Storybook's
        // default "padded" canvas adds margin around the story, which pushes the
        // full-height page past the viewport and causes a scrollbar on every
        // story. "fullscreen" removes that padding so pages render edge-to-edge.
        layout: "fullscreen",
        controls: {
            matchers: {
